...
func StartBot() {
	...
	b.Handle(&tele.Btn{Unique: "menu_info"}, func(c tele.Context) error { return handleMenuInfoClean(c, b) })
	...
	b.Handle(&tele.Btn{Unique: "install_ssl"}, func(c tele.Context) error { return handleInstallSSL443(c, b) })
	b.Handle(&tele.Btn{Unique: "test_ssl443"}, func(c tele.Context) error { return handleTestSSL443(c, b) })
	...
	b.Handle(&tele.Btn{Unique: "uninstall_ssl"}, func(c tele.Context) error { return handleUninstallSSL443(c, b) })
