...
func StartBot() {
	...
	b.Handle(&tele.Btn{Unique: "uninstall_sshws"}, func(c tele.Context) error { return handleUninstallSSHWS200(c, b) })
...
func buildMainMenuMarkup(chatID int64) *tele.ReplyMarkup {
	...
	btnCrear := menu.Data("🔐 Crear Cliente", "menu_crear")
	btnInfo := menu.Data("📊 Estado VPS", "menu_info")
	btnEditar := menu.Data("✏️ Editar Cliente", "menu_editar")
	btnDelete := menu.Data("🗑️ Eliminar Cliente", "menu_eliminar")
	btnInfoCuenta := menu.Data("ℹ️ Info Cliente", "menu_info_cuenta")
	btnGlobal := menu.Data("📢 Mensaje Global", "menu_broadcast")
	btnScanner := menu.Data("🔍 Escáner", "menu_scanner")
	btnOnline := menu.Data("🟢 Clientes Online", "menu_online")
	btnProtocols := menu.Data("🚀 Protocolos VPN", "menu_protocols")
