...
markup := &tele.ReplyMarkup{}
btnInst := markup.Data("📥 Activar WebSocket 200", "install_sshws")
btnUninst := markup.Data("🛑 Detener WebSocket 200", "uninstall_sshws")
btnBack := markup.Data("🔙 Volver", "menu_protocols")

markup.Inline(markup.Row(btnInst), markup.Row(btnUninst), markup.Row(btnBack))

status := "❌ Desinstalado / Inactivo"
if exec.Command("bash", "-c", "systemctl is-active --quiet darkzsaid-ws200 && ss -tulnp 2>/dev/null | grep -q ':80'").Run() == nil {
status = "✅ Activo en puerto 80"
}

texto := "🚀 <b>Gestión WebSocket 200 Established</b>\n\n"
...
res := "✅ <b>WebSocket 200 Established Activado</b>\n"
res += "━━━━━━━━━━━━━━\n"
res += "🌐 <b>IP:</b> <code>" + ip + "</code>\n"
res += "📡 <b>Puerto:</b> <code>80</code>\n"
...
func handleUninstallSSHWS200(c tele.Context, b *tele.Bot) error {
markup := &tele.ReplyMarkup{}
markup.Inline(markup.Row(markup.Data("🔙 Volver", "submenu_sshws")))
